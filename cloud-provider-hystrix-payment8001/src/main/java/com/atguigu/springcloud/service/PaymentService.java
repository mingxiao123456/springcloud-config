...
public class PaymentService {
    ...
    public String paymentInfo_OK(Integer id){
        return "线程池： " + Thread.currentThread().getName() + " paymentInfo_OK，id： " + id + "\t" + "hahahahaha";
    }
    ...
    public String paymentInfo_Timeout(Integer id){
        ...
        return "线程池： " + Thread.currentThread().getName() + " paymentInfo_Timeout，id： " + id + "\t" + "hahahahaha";
    }

    public String paymentInfo_TimeoutHandler(Integer id){
        return "线程池： " + Thread.currentThread().getName() + " 系统繁忙或者运行报错，请稍后再试，id： " + id + "\t" + "wuwuwuwuwu";
    }
    ...
    public String paymentCircuitBreaker_fallback(@PathVariable("id") Integer id){
        ...
        return "id 不能负数，请稍后再试，wuwuwuwu  id： " + id;
